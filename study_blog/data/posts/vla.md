...
- 具身智能
- 机器人
summary: 从 Google 的 RT-1 到 Physical Intelligence 的 π0，从学术界的开源反击到人形机器人浪潮——VLA 领域三年来的技术演进与群雄逐鹿。
---
...
第一个篇章，机器学会了**看和说**。它们能看懂图片，能理解语言，能把视觉和文字联系起来。这就是 **VLM（Vision-Language Model）**。

第二个篇章，机器学会了**做**。它们不再只是旁观者，而是伸出了手，开始操控物理世界。这就是 **VLA（Vision-Language-Action）**。

第三个篇章，机器学会了**想象**。它们不再盲目行动，而是在行动前先"脑补"后果，预见未来。这就是 **WAM（World Action Model）**。
...
LLaVA 的真正贡献不是性能，而是**可复现性**。它证明了：你不需要 Google 级别的算力，不需要闭源 API，一张 A100 就能训练出一个强大的 VLM。这直接引爆了学术界的 VLM 研究浪潮。
...
**第一条路线**来自 Google 的 Brain 团队（此时已与 DeepMind 合并），产物是 **PaLM-E** [2]。
...
**第二条路线**来自 Google DeepMind 的机器人团队，产物是 **RT-2** [3]。
...
- 视觉编码器：**SigLIP**（Google 的改进版 CLIP）
- 语言模型：**Llama 2**（Meta 的开源 LLM）
- 动作输出：直接回归连续值（不走 RT-2 的离散化路线）
...
- **硬件可靠性**：人形机器人的关节、电机、电池，能否支持 8 小时连续工作？
- **安全性**：一个几十公斤重的金属人，如果失控，后果不堪设想
- **成本**：一台人形机器人的售价可能在 10-20 万美元，谁会买？
...
- **上海 AI Lab**：在具身智能仿真平台（InternSim）和数据集方面有重要贡献
- **智元机器人（Agibot）**：由"稚晖君"彭志辉创立，专注人形机器人的端到端控制
- **银河通用（Galbot）**：聚焦通用人形机器人，强调灵巧手操作能力
- **宇树科技（Unitree）**：以四足机器人起家，正在向人形机器人扩展
...
这就是 **世界模型（World Model）** 的核心思想。而当世界模型和 VLA 结合，就诞生了 **WAM（World Action Model）**——不仅能看、能说、能做，还能**想象**。
...
Dreamer 系列（DreamerV2、DreamerV3）在游戏控制和机器人任务上取得了出色的成绩。但它们有一个局限：世界模型是在**特定任务**上学习的。Dreamer 学会了在 Atari 游戏里预测下一步，但让它预测真实厨房里的物理变化，就无能为力了。
...
- **视觉表征**：理解游戏画面是什么样的
- **动作推断**：从画面变化中推断玩家按了什么键
- **动态预测**：预测按下某个键后，画面会变成什么样
...
UniSim 还可以用来做**数据增强**：在真实数据不够的情况下，用世界模型"生成"更多训练数据。这就像给 VLA 模型一个"梦境训练场"——在想象中练习几千次，再部署到真实世界。
...
- **Physical Intelligence (π)**：技术最强，融资最多，π0 系列持续迭代，但产品尚未大规模落地
- **Google DeepMind**：奠基者，内部重组后方向不够聚焦，但人才储备深厚
- **NVIDIA**：基础设施提供者，Gr00t 系列瞄准人形机器人

**第二梯队**：

- **学术开源社区**（Stanford、Berkeley、清华等）：推动技术民主化
- **Meta FAIR**：在视觉表征和基础模型方面有深厚积累
- **Microsoft Research**：在仿真和 sim-to-real 方面持续投入
...
[1] Brohan, A., et al. "RT-1: Robotics Transformer for Real-World Control at Scale." *RSS 2023*. [arXiv:2212.06204](https://arxiv.org/abs/2212.06204)

[2] Driess, D., et al. "PaLM-E: An Embodied Multimodal Language Model." *ICML 2023*. [arXiv:2302.13101](https://arxiv.org/abs/2302.13101)

[3] Team, R., et al. "RT-2: Vision-Language-Action Models Transfer Web Knowledge to Robotic Control." *CoRL 2023*. [arXiv:2307.15818](https://arxiv.org/abs/2307.15818)

[4] Team, O., et al. "Octo: An Open-Source Generalist Robot Policy." *RSS 2024*. [arXiv:2405.12213](https://arxiv.org/abs/2405.12213)

[5] Kim, M. J., et al. "OpenVLA: An Open-Source Vision-Language-Action Model." *arXiv 2024*. [arXiv:2406.09246](https://arxiv.org/abs/2406.09246)

[6] Black, K., et al. "π0: A Vision-Language-Action Flow Model for General Robot Control." *Physical Intelligence, 2024*. [arXiv:2410.24164](https://arxiv.org/abs/2410.24164)

[7] Liu, S., et al. "Robotic Transformer with Diffusion: A Survey." *arXiv 2024*. [arXiv:2403.15190](https://arxiv.org/abs/2403.15190)

[8] Team, S., et al. "SimplerEnv: A Simulated Evaluation Benchmark for Real-World Robot Manipulation." *arXiv 2024*. [arXiv:2408.03911](https://arxiv.org/abs/2408.03911)

[9] DROID: "A Large-Scale In-The-Wild Robot Manipulation Dataset." *arXiv 2025*. [arXiv:2407.11788](https://arxiv.org/abs/2407.11788)
...
[12] Radford, A., et al. "Learning Transferable Visual Models From Natural Language Supervision." *ICML 2021*. [arXiv:2103.00020](https://arxiv.org/abs/2103.00020)

[13] Caron, M., et al. "Emerging Properties in Self-Supervised Vision Transformers." *ICCV 2021*. [arXiv:2104.14294](https://arxiv.org/abs/2104.14294)

[14] Zhai, X., et al. "Sigmoid Loss for Language Image Pre-Training." *ICCV 2023*. [arXiv:2203.15557](https://arxiv.org/abs/2203.15557)

[15] Open X-Embodiment Collaboration. "Open X-Embodiment: Robotic Learning Datasets and RT-X Models." *ICRA 2024*. [arXiv:2310.08864](https://arxiv.org/abs/2310.08864)

[16] Mees, O., et al. "CALVIN: A Benchmark for Language-Conditioned Robot Learning." *RAL 2022*. [arXiv:2110.07455](https://arxiv.org/abs/2110.07455)

[17] James, S., et al. "RLBench: The Robot Learning Benchmark & Learning Environment." *RAL 2020*. [arXiv:1909.12271](https://arxiv.org/abs/1909.12271)

[18] Chi, C., et al. "Diffusion Policy: Visuomotor Policy Learning via Action Diffusion." *RSS 2023*. [arXiv:2303.04137](https://arxiv.org/abs/2303.04137)

[19] Zhao, T. Z., et al. "Learning Fine-Grained Bimanual Manipulation with Low-Cost Hardware (ACT)." *RSS 2023*. [arXiv:2304.13705](https://arxiv.org/abs/2304.13705)

[20] Alayrac, J.-B., et al. "Flamingo: a Visual Language Model for Few-Shot Learning." *NeurIPS 2022*. [arXiv:2204.14198](https://arxiv.org/abs/2204.14198)

[21] Liu, H., et al. "Visual Instruction Tuning." *NeurIPS 2023*. [arXiv:2304.08485](https://arxiv.org/abs/2304.08485)

[22] Bai, J., et al. "Qwen-VL: A Versatile Vision-Language Model for Understanding, Localization, Text Reading, and Beyond." *arXiv 2023*. [arXiv:2308.12966](https://arxiv.org/abs/2308.12966)

[23] Hafner, D., et al. "Dream to Control: Learning Behaviors by Latent Imagination." *ICLR 2020*. [arXiv:1912.01603](https://arxiv.org/abs/1912.01603)

[24] Alonso, E., et al. "Transformers are Sample-Efficient World Models." *ICLR 2024*. [arXiv:2209.00588](https://arxiv.org/abs/2209.00588)

[25] Bruce, J., et al. "Genie: Generative Interactive Environments." *ICML 2024*. [arXiv:2402.15391](https://arxiv.org/abs/2402.15391)

[26] Alonso, E., et al. "DIAMOND: Diffusion As a Model Of eNtion Dreams." *arXiv 2024*. [arXiv:2405.12399](https://arxiv.org/abs/2405.12399)

[27] Yang, M., et al. "UniSim: A Universal Interactive Simulator for Robot Learning." *arXiv 2024*. [arXiv:2406.12715](https://arxiv.org/abs/2406.12715)

---

本文档基于截至 2025 年的公开文献整理。VLA 领域发展迅速，建议定期更新。  
部分机构关系和人员流动信息基于公开报道，如有不准确之处欢迎指正。
